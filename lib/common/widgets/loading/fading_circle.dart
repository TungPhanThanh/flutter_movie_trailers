...
import 'package:flutter_movie/common/widgets/loading/tweens/delay_tween.dart';
...
class LoadingFadingCircle extends StatefulWidget {
  ...
  @override
  _LoadingFadingCircleState createState() => _LoadingFadingCircleState();
}

class _LoadingFadingCircleState extends State<LoadingFadingCircle> with SingleTickerProviderStateMixin {
